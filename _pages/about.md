...
Currently, I am exploring Physics-Informed Neural Networks (PINNs) and neural operators such as Fourier Neural Operators (FNOs) and Convolutional Neural Operators (CNOs) as next-generation CFD surrogates. My work focuses on embedding governing flow equations directly into neural network training through carefully designed loss formulations, enabling models to generalize across geometries and flow regimes while maintaining physical consistency. Through this research, I aim to advance the integration of AI and CFD, developing hybrid frameworks that accelerate simulations, improve predictive accuracy, and support sustainable engineering design. I am actively seeking PhD opportunities where I can further pursue research at the intersection of CFD, machine learning, and high-performance computing.
